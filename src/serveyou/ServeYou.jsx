...
const Services = ({ cartValue, setCartValue }) => (
    <div className="page-content">
        <div className="title-section">
            <h1>Take Order</h1>
            <p>
                Place order
                <button onClick={() => addCart(10, cartValue, setCartValue)}>Pizza</button>
                {cartValue}
            </p>
            ...
            <Layout>
                {({ cartValue, setCartValue }) => (
                    <Routes>
                        ...
                        <Route path="/services" element={<Services cartValue={cartValue} setCartValue={setCartValue} />} />
