...
import store, { addToCart } from "./reduxstore";
import wallet, { addwallet } from "./storetest";
import walletstore from "./storetest";
    ...
    return (
        <div className="page-content">
            <div className="title-section">
                ...
                <p>
                    Place order
                    <button onClick={() => dispatcher(addToCart(100))}>Pizzaaaa</button>
                    <button onClick={() => dispatcher(addToCart(200))}>Burger</button>
                    <button onClick={() => dispatcher(addToCart(10))}>Coffee</button>
                    <button onClick={() => dispatcher(addwallet(10))}>Add Money</button>
                </p>
                <p>{cart}</p>
...
const Contact = () => {
    const carVal = useSelector((state) => state.cart.value)
